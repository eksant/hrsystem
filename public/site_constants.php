<?php
           ...
           defined('TIME_FORMAT') || define('TIME_FORMAT','H:i');   
           defined('TIMEZONE_OFFSET') || define('TIMEZONE_OFFSET','+08:00');   
           defined('CURRENCY_FORMAT') || define('CURRENCY_FORMAT','Rupiah(IDR)');
